...
BOT_TOKEN = environ.get('BOT_TOKEN', "8556717356:AAEd9H-PscMJOnodqPeUDAPUIkj70wBLEvI")    # Bot token from @BotFather
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1446756865').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003418868635').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003359947763'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003359947763'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003359947763'))  # Premium logs channel id
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/talkwithmejinwoo')  # Support group link (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Luffy624:nhROZY7yHvo6YhI4@cluster0.8iytwqc.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002440508419'))  # Notification of sent to your channel
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/talkwithmejinwoo') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Jinwoo4596_bot') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+4EwlVtuQt81hOGI1') # Update channel link for the bot
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'askmetelugu1'))
MULTI_CLIENT = False
name = str(environ.get('name', 'askmetelugu1'))
